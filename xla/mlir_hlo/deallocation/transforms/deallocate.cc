...
struct Deallocator {
  ...
  FailureOr<TransformResult> transformFuncOp(func::FuncOp op);
...
FailureOr<TransformResult> Deallocator::transformFuncOp(func::FuncOp op) {
